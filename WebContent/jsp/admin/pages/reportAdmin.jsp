...
<html>
	...
	<body>
		...
		<form action="admin/caseBack/showCaseByCompany.do" method="post">
			<div class="row">
				<h1><small>举报管理</small></h1>
				<div class="page-header"></div>
				<div class="form-inline">
					<div class="form-group">
						<label class="control-label">选择时间段：</label>
						<input type='text' name="startTime"  style="width: 110px;" class="datepicker-here form-control" data-position="right top" />  
					</div>
					<div class="form-group">
						<label class="control-label">到</label>
						<input type='text' name="endTime"  style="width: 110px;" class="datepicker-here form-control" data-position="right top" />
					</div>
			...
			<div class="row">
				<div class="form-inline">
					<div class="form-group">
						...
						<input type="text" name="keyWord" class="form-control" style="width: 200px;" placeholder="可查询问题答案关键字">
					</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$.get(url,function(res){
				var tr = $("<tr/>");
				var td1 = $("<td/>").text("${caseInfo.reporter.name}");
