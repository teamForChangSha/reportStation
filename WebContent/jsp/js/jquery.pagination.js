...
(function($){
    ...
    // Extend jQuery
    $.fn.pagination = function(maxentries, opts){//maxentries 总条目数	必选参数，整数

        // Initialize options with default values
        opts = $.extend({
            items_per_page:1,//每页显示的条目数	可选参数，默认是10
            ...
            prev_text:"<i></i>上一页",//“前一页”分页按钮上显示的文字	字符串参数，可选，默认是"Prev"
            next_text:"下一页 <i></i>",//“下一页”分页按钮上显示的文字	字符串参数，可选，默认是"Next"
