...
<html>
	...
	<head>
		...
		<script src="../bootstrap3/js/localdata.js" type="text/javascript" charset="utf-8"></script>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="col-sm-10">
						...
						<h1><small>我要举报</small></h1>
					</div>
					<form action="" method="post" class="form-horizontal">
						<div class="input-group form-group">
							<span class="input-group-btn">
        							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    									选择企业 <span class="caret"></span>
							<span class="sr-only">Toggle Dropdown</span>
							</button>
							<ul class="dropdown-menu" id="etpList">
							</ul>
							</span>
							<input type="text" id="keyword" class="form-control" placeholder="请输入被举报的企业" />
							<span id="keywordIcon" class="glyphicon form-control-feedback" aria-hidden="true"></span>
							<span class="input-group-btn">
				...
				<div class="col-sm-7">
					<div class="page-header text-center">
						<h1><small>我们承诺</small></h1>
					</div>
					<div class="jumbotron">
						<div class="container">
							Belden 是一家拥有高度负责和诚信价值观的组织。 我们的 商业行为与道德准则 包含以最高道德标准开展业务的一般性指南。

Belden 承诺创建一个坦诚、诚实交流而非排除在外的环境。 我们希望在您认为有违反政策或标准的行为发生时，能够适应向您的主管或管理层举报，而不会遭到报复。

在您希望能够以保密、匿名的方式进行举报的情况下，我们鼓励您使用此热线电话，该电话由第三方热线电话提供商 EthicsPoint 提供。 我们鼓励您提交与我们的 商业行为和道德准则中所列违规行为有关的举报，询问有关政策和程序的指南并提供积极的建议和故事。

EthicsPoint 将会按照您的选择以完全保密和匿名的方式，把您提供的信息发送给我们。 我们保证您的意见将会得到听取。
						</div>
					</div>
				</div>
			</div>
					...
					<div class="modal-body">
						<div class="row" id="row-right">
							<div class="col-sm-12">
								<form action="" method="post" class="form-horizontal" style="margin-bottom: 15px;">
									<div class="input-group form-group">
										<input id="num" type="text" class="form-control" placeholder="请输入跟踪单号">
										<span id="numIcon" class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="input-group-btn">
						...
						<div class="row" id="row-right">
							<div class="col-sm-12">
								<form action="" method="post" class="form-horizontal">
									<div class="input-group form-group">
										<input id="phone" type="text" maxlength="11" class="form-control" placeholder="请输入实名手机号">
										<span id="phoneIcon" class="glyphicon form-control-feedback" aria-hidden="true"></span>
										<span class="input-group-btn">
        							<button id="phoneBtn" class="btn btn-default" type="button">获取临时密码</button>
      							</span>
									</div>
									<div class="input-group form-group">
										<input id="pwd" type="password" maxlength="6" class="form-control" placeholder="请输入临时密码">
	...
	<script src="../bootstrap3/js/index.js" type="text/javascript" charset="utf-8"></script>
