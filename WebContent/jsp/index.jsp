...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4">
				<div class="col-sm-10">
					...
					<form action="" method="post" class="form-horizontal">
						...
						<div class="form-group hidden">
							<input type="button" class="btn btn-primary btn-block" id="next"
								value="下一步" />
						</div>
					</form>
					<div class="alert alert-warning">
						完成举报后，您将获得一个唯一的<strong>“案件编号”</strong>。 记录您的案件编号和密码并将其保存在安全的地方。
						5-6 个工作日后，请使用您的案件编号或密码检查报告的反馈或问题。
					</div>
					<br />
			...
			<div class="col-sm-7">
				...
				<div class="jumbotron">
					<div class="container">Belden 是一家拥有高度负责和诚信价值观的组织。 我们的
						商业行为与道德准则 包含以最高道德标准开展业务的一般性指南。 Belden 承诺创建一个坦诚、诚实交流而非排除在外的环境。
						我们希望在您认为有违反政策或标准的行为发生时，能够适应向您的主管或管理层举报，而不会遭到报复。

						在您希望能够以保密、匿名的方式进行举报的情况下，我们鼓励您使用此热线电话，该电话由第三方热线电话提供商 EthicsPoint
						提供。 我们鼓励您提交与我们的 商业行为和道德准则中所列违规行为有关的举报，询问有关政策和程序的指南并提供积极的建议和故事。
	...
	<!--登陆对话框-->
	<div class="modal fade bs-example-modal-sm" id="loginPanel"
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="userPages/forget_pwd.html" target="_blank" id="forgetPwd"
						type="button" class="btn btn-link">忘记密码</a>
				</div>
			</div>
		</div>
	</div>
	...
	<!--查询对话框-->
	<div class="modal fade bs-example-modal-sm" id="reportPanel"
		tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
							...
							<form action="" method="post" class="form-horizontal">
								<div class="input-group form-group">
									<input id="phone" type="text" maxlength="11"
										...
										aria-hidden="true"></span> <span class="input-group-btn">
										<button id="phoneBtn" class="btn btn-default" type="button">获取临时密码</button>
									</span>
								</div>
								<div class="input-group form-group">
									<input id="pwd" type="password" maxlength="6"
										...
										aria-hidden="true"></span> <span class="input-group-btn">
										<button id="pwdBtn" class="btn btn-default" type="button">查询</button>
									</span>
								</div>
							</form>
						</div>
				...
				<div class="col-sm-10">
					...
					<form action="" method="post" class="form-horizontal">
						<div class="input-group form-group">
							...
							</span> <input type="text" id="keyword" class="form-control"
								placeholder="请输入被举报的企业" /> <span id="keywordIcon"
								class="glyphicon form-control-feedback" aria-hidden="true"></span>
							<span class="input-group-btn">
								<button id="getArea" class="btn btn-default" type="button">GO!</button>
							</span>
						...
						<div class="form-group hidden">
							<select id="seachprov" class="form-control" name="seachprov">
								<option value="-1">请选择</option>
							</select>
						</div>
						<div class="form-group hidden">
							<select id="seachcity" class="form-control" name="homecity">
								<option value="-1">请选择</option>
							</select>
						</div>
						<div class="form-group hidden">
...
<script src="../bootstrap3/js/index.js" type="text/javascript"
	charset="utf-8"></script>
>>>>>>> branch 'master' of
https://github.com/teamForChangSha/reportStation.git
