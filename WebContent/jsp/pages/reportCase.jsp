...
<body>
		...
		<form action="" method="post" class="form-horizontal">
				...
				<div class="col-sm-8" id="content">
					...
					<div class="form-group text-center">
						<input type="checkbox" value="" /> <label><span
							class="xinghao">*</span>是 – 我同意这项报告相关的 <a href="#"
							class="btn-link" data-toggle="modal"
							data-target="#agreeMentPanel">条款与条件</a> </label>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<span class="form-info"><strong>Oracle
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong><span class="xinghao">*</span>您是 XXX
								的员工吗？</strong> </span> <br /> <label class="radio-inline"> <input
							type="radio" name="employees" value="true" /> 是
						</label> <label class="radio-inline"> <input type="radio"
							checked="true" name="employees" value="false" /> 否
						</label>
					</div>
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong><span class="xinghao">*</span>对于这项报告，您是否希望保持匿名身份？</strong>
						</span> <br /> <label class="radio-inline"> <input type="radio"
							name="reportType" value="true" /> 是
						</label> <label class="radio-inline"> <input type="radio"
							checked="true" name="reportType" value="false" /> 否
						</label>
					</div>
					<div id="userInfo">
						<div class="form-group text-center">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input id="name" type="text" class="form-control"
									placeholder="名字"></input>
							</div>
							<div class="col-sm-3">
								<input id="surnames" type="text" class="form-control"
									placeholder="姓氏"></input>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input id="certificateNum" type="text" class="form-control"
									placeholder="证件号"></input>
							</div>
						</div>
						<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-sm-8" id="bom">
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>您是否怀疑或知道监督或管理人员与此有关？</strong></span> <br /> <label
							class="radio-inline"> <input type="radio" id="niming"
							name="reportType" /> 是
						</label> <label class="radio-inline"> <input type="radio"
							id="shiming" name="reportType" /> 否
						</label> <label class="radio-inline"> <input type="radio"
							id="shiming" name="reportType" /> 不知道 / 不愿意透露
						</label>
						<p>如果选择是，请指出是谁？</p>
						<div class="col-sm-3"></div>
						<div class="col-sm-7">
							<textarea type="text" rows="6" class="form-control"
								placeholder="例如：无名氏，内部审计主管"></textarea>
						</div>
					</div>
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>管理人员注意到此问题了吗？</strong></span> <br /> <label
							class="radio-inline"> <input type="radio" id="niming"
							name="reportType" /> 是
						</label> <label class="radio-inline"> <input type="radio"
							id="shiming" name="reportType" /> 否
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>此事件的总体特征是什么？</strong></span> <br />
					</div>
					<div class="form-group">
						<div class="col-sm-3"></div>
						<div class="col-sm-7">
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>您估计这一行为的货币价值是多少？</strong></span> <br />
					</div>
					<div class="form-group">
						<div class="col-sm-3"></div>
						<div class="col-sm-2">
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>该事件或违规行为在哪里发生的？</strong></span> <br />
					</div>
					<div class="form-group">
						<div class="col-sm-3"></div>
						<div class="col-sm-7">
					...
					<div class="page-header"></div>
					<div class="form-group text-center">
						<span><strong>请指出该事件发生的确切或大致时间：</strong></span> <br />
					</div>
					<div class="form-group">
						<div class="col-sm-3"></div>
						<div class="col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<textarea type="text" rows="6" class="form-control"
								placeholder="例如：忽略事件；更改文档；说这不是个问题；说他们会调查"></textarea>
							<p>请指出其姓名和职位。</p>
						</div>
					</div>
					<div class="page-header"></div>
					...
					<div class="form-group text-center">
						<p class="bg-danger">
							您提交报告时，将会发给您一个举报编号。请记下此编号并存放在安全的地方。在5-6个营业日后，您通过网站或热线电话返回
							EthicsPoint
							时，我们会要求您使用此举报编号以及您选择的密码。在5-6个营业日后返回，您将有机会查阅任何"后续问题"或提交关于此事件的更多信息。
						</p>
					</div>
					<div class="form-group text-center">
						<div class="page-header"></div>
						<span><strong> 此外，在可能的情况下，请附上任何支持您在本次报告中所提供信息的文档。</strong></span>
						<br /> <a href="#" class="btn-link" data-toggle="modal"
							data-target="#upLoadPanel">单击此处上传文件</a> <br />
						<p>（可上传大多数常见的文件类型。）</p>
					</div>
					<div class="form-group text-center">
						<div class="page-header"></div>
						<h3>
							<span class="label label-danger">当前案件编号为：AB09C80567</span>
						</h3>
					...
					<div class="form-group">
						<label class="col-sm-4 control-label">密码<span
							class="xinghao">*</span></label>
						<div class="col-sm-4">
							<input type="password" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">再次输入密码<span
							class="xinghao">*</span></label>
						<div class="col-sm-4">
							<input type="password" class="form-control" />
						</div>
					...
					<div class="form-group">
						<div class="col-sm-4"></div>
						<div class="col-sm-4">
							<input type="button" id="submitReport"
								class="form-control btn btn-primary" value="提交报告" />
						</div>
					</div>
				</div>
			</div>
	...
	<!--条款对话框-->
	<div class="modal fade bs-example-modal-lg" id="agreeMentPanel"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<iframe src="agreement.html" frameborder="0" width="100%"
						height="400px"></iframe>
				</div>
			</div>
		</div>
	...
	<!--上传文件对话框-->
	<div class="modal fade bs-example-modal-lg" id="upLoadPanel"
		tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<iframe src="upLoadFile.html" frameborder="0" width="100%"
						height="400px"></iframe>
				</div>
			</div>
		</div>
...
<script src="../bootstrap3/js/reportCase.js" type="text/javascript"
	charset="utf-8"></script>
