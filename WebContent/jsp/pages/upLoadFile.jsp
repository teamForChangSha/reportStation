...
<script type="text/javascript">
    $(function () {
        ...
        getFiles();
        function getFiles() {
            $.get("case/showFileList.do?trackingNo=${trackingNo }", function (res, state) {
                if (state == "success") {
                    res = JSON.parse(res);
                    setFiles(res);
                    window.parent.getFileList(res);
                }
            });
        }
